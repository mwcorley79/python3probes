...
# C++ since the Python and C# object models are based on reference semantics 
# while C++ is based on value semantics  
...
print("""Note: if emp2 is deleted excplicity (the above line), you'll see the 
          destructor announced before this message, otherwise is the reference is deleted
          when the object goes out scope... in which case you'll see announce after this message """);
